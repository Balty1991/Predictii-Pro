...
O verificare DOM pe versiunea GitHub Pages a confirmat prezența simultană a țintei, statutului „În interval”, returului potențial, profitului potențial şi selecției verificate în calculatorul live.
